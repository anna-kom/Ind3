...
std::vector <GameObject> grassRightObjects;
GameObject bus;
...
//            0.0, 0.0, -1.0, 0.0);
//        
//        vec4 n = vec4(normCoord * mat3(
//            cos(move[0]), 0, sin(move[0]),
//            0,           1,         0,
//            -sin(move[0]), 0, cos(move[0])), 1.0) * pers ;
//        normal = vec3(n[0], n[1], n[2]);
//
//        vec3 bus_pos = vertCoord * mat3(
//            cos(move[0]), 0, sin(move[0]),
//            0,           1,         0,
//            -sin(move[0]), 0, cos(move[0]));
//
//        vec4 shift_pos = vec4(bus_pos[0] + shift[0] * 68 + move[1], bus_pos[1] + 10 - shift[0], bus_pos[2] - shift[1], 1.0);
//        vec4 pos = shift_pos * pers;
//
